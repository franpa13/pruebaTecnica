...
export const Title = ({
    ...
    return (
        <div className="">
            <h1
                aria-label={text} className={` text-shadow-lg md:pl-4  md:gap-2 justify-center  capitalize flex items-start text-2xl md:text-4xl font-extrabold text-black dark:text-white  ${color}`}
            >
                {text}
